...
def whenpigsfly(num_rolls, uncapped_score):
    return min(25 - num_rolls, uncapped_score)

def porkchop(diceswapped):
    turnscore = 1
    diceswapped = not diceswapped
    return turnscore, diceswapped
...
def swineswap(score0, score1):
    ...
    if score0/score1 == 2 or score0/score1 == 0.5:
        switch = score0
        score0 = score1
        score1 = switch
        return score0,score1
...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    "*** REPLACE THIS LINE ***"
    if num_rolls == 0:
        initial = free_bacon(opponent_score)
    else:
        initial = roll_dice(num_rolls, dice)
    updated = hogtimus_prime(initial)
    final = whenpigsfly(num_rolls, updated)
...
def play(strategy0, strategy1, score0=0, score1=0, goal=GOAL_SCORE):
    ...
    while (score0 < goal and score1 < goal):
        if player == 0:
            ...
            if num_rolls == -1:
                score, dice_swapped = porkchop(dice_swapped)
            else:
...
def check_strategy(strategy, goal=GOAL_SCORE):
    ...
    while s < goal:
        o_s = 0
        while o_s < goal:
            num_rolls = strategy(s, o_s)
            check_strategy_roll(s, o_s, num_rolls)
            o_s += 1
        s += 1
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    while rolls <= 10:
        ...
        score = averaged_dice(rolls, dice)
        scorelist.append(score)
        rolls += 1
    numlist.append(scorelist.index(max(scorelist)))

    return min(numlist)+1
...
def bacon_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    updated_score = hogtimus_prime(bacon_score)
    if updated_score >= margin:
        rolls = 0
    else:
        rolls = num_rolls
    return rolls
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    updated_score = hogtimus_prime(turnscore)
    finalscore = updated_score + score
    rolls = 0
    if finalscore == 0 or opponent_score == 0:
        return num_rolls
    if finalscore/opponent_score == 0.5:
        return rolls
    if finalscore/opponent_score == 2:
        return num_rolls
    if updated_score >= margin:
        return rolls
    else:
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE **
    ...
    test = swap_strategy(score, opponent_score, 8, 6)
    ...
    if opponent_score > 0:
        porkscore, porkopp = swineswap(score+1,opponent_score)
        if porkscore/porkopp == 2:
            return -1
    
    if score >= 50:
        if opponent_score >= 50:
            return 5
        elif opponent_score != 0 and (score+bacon_score)/opponent_score != 2:
            return 0
